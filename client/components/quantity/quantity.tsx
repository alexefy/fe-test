...
const Quantity = ({ updateQtySelected }) => {
  ...
  return(
    <div className='flex items-center pb-5'>
      <Button isDisabled={quantity <= 1 ? true : false} title="minus" onClick={minusQuantity} isIconButton>
      ...
      <Button isDisabled={quantity >= 5 ? true : false} title="plus" onClick={addQuantity} isIconButton>
